...
eval "$(/home/eric/anaconda3/bin/conda shell.bash hook)"
...
cmake -DCMAKE_DISABLE_FIND_PACKAGE_pypy=ON ../.. -DPYTHON_EXEC=/home/eric/anaconda3/envs/${CONDA_ENV_NAME}/bin/python
